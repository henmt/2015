...
### Job name
#PBS -N cuffdiff_130628ShulyLim_F5_reference_only
...
setenv CUFFDIFF_RUN_NAME F5_reference_only
...
setenv WILDTYPE ${BAMS_DIR}/WT-F5-Rep1_ACTTGA_L007_R1.trimmed.tophat2_pe.mm10.bam,${BAMS_DIR}/WT-F5-Rep2_GGCTAC_L007_R1.trimmed.tophat2_pe.mm10.bam,${BAMS_DIR}/WT-F5-Rep3_GTGGCC_L007_R1.trimmed.tophat2_pe.mm10.bam
setenv MUTANT ${BAMS_DIR}/Mut-F5-Rep1_ACAGTG_L008_R1.trimmed.tophat2_pe.mm10.bam,${BAMS_DIR}/Mut-F5-Rep2_CAGATC_L008_R1.trimmed.tophat2_pe.mm10.bam,${BAMS_DIR}/Mut-F5-Rep3_CTTGTA_L008_R1.trimmed.tophat2_pe.mm10.bam
